...
const BACKEND_URL = import.meta.env.VITE_BACKEND_URL || "https://agent-one-gamma.vercel.app";
      ...
      <section className="chat-card">
        <header className="top-strip">
          <div className="brand-wrap">
            <img className="logo-mark" src={LOGO_URL} alt="LPU logo" />
            <div>
        ...
        <section className="hero-banner">
          <h2>LPU Admissions help</h2>
          <p>
            Use this assistant to book a campus visit, ask course questions, or get admissions support.
          </p>
